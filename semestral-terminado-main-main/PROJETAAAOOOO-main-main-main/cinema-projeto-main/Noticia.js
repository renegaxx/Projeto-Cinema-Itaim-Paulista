...
function alterarEstilo() {
    ...
    if (novoVideo === 'RedPaintCombustion.mp4') {
        ...
        const tituloNoticia = document.querySelector('.titulo-noticia span');
        tituloNoticia.style.color = 'black';

        const sobreFilmes = document.querySelector('#sobre-noticia span');
        sobreFilmes.style.color = 'black';

        const textosCima = document.querySelectorAll('.texto-cima a');
